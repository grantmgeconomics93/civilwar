...
```{r}
# Finish the formula
formula <- as.formula("growth ~ growth_lag1 + growth_lag2 + growth_lag3 + growth_lag4 + 
                      war_lag1 + war_lag2 + war_lag3 + war_lag4 + 
                      above_one_after_war_lag1 + above_one_after_war_lag2 + above_one_after_war_lag3 + above_one_after_war_lag4 + 
                      prewwar_lag1 + prewwar_lag2 + prewwar_lag3 + prewwar_lag4 + 
                      year_since_start_lag1 + year_since_start_lag2 + year_since_start_lag3 + year_since_start_lag4")

# Estimate the model
model <- plm(formula, data = pdf, model = "within")
